...
class GFG
{
    ...
    {
        Date dt1 = new Date(23, 2, 1990);
        Date dt2 = new Date(19, 1, 2022);
        System.out.println("Difference between two dates is " +
                getDifference(dt1, dt2));
        // test
        System.out.println(countLeapYears(dt1));
        System.out.println(countLeapYears(dt2));
        System.out.println(getDiff1(dt1));
        System.out.println(getDiff1(dt2));
